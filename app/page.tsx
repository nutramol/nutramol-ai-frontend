...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-white">
      {/* FlowiseChat embed (görünmez — sohbet butonunu yönetir) */}
      <FlowiseChat />
      ...
      <section className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-between px-6 pb-24 pt-10 lg:flex-row">
        ...
        >
          ...
          <p className="mt-8 max-w-xl text-lg leading-8 text-gray-600">
            ...
            bilimsel sağlık araştırmaları için geliştirilmiş yeni nesil yapay zeka
            platformudur.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            {[
              ...
              <div
                key={label}
                className="flex items-center gap-2 rounded-2xl bg-white px-4 py-3 shadow-sm ring-1 ring-gray-100"
              >
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <button
              onClick={openChat}
              className="group flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 px-8 py-4 font-semibold text-white shadow-lg shadow-emerald-200 transition hover:bg-emerald-700"
            >
              AI Asistanını Dene
          ...
          <div className="overflow-hidden rounded-[32px] border border-gray-200 bg-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
              <div>
                ...
                <p className="text-sm text-emerald-600">Online • Bilimsel AI</p>
              </div>
              <div className="h-3 w-3 rounded-full bg-emerald-500 animate-pulse" />
            </div>

            {/* ✅ HTTP → HTTPS (SSL gerektirir!) */}
            <iframe
              src={`${FLOWISE_HOST}/chatbot/${CHATFLOW_ID}`}
              width="100%"
              height="650"
              style={{ border: "none" }}
          ...
          {[
            {
              ...
              title: "RAG Destekli Yapay Zeka",
              desc: "Yapay zeka cevapları bilimsel kaynaklarla desteklenerek daha güvenilir hale getirilir.",
            },
            {
              icon: <ShieldCheck className="text-emerald-600" />,
              title: "Bilimsel Kanıt Temelli Yaklaşım",
              desc: "PubMed ve bilimsel araştırmalar temel alınarak sağlık bilgi akışı sağlanır.",
            },
            {
              icon: <ArrowRight className="text-emerald-600" />,
              title: "Yapay Zeka Destekli Etkileşim",
              desc: "Kullanıcılar sağlık konularını doğal dil ile hızlı ve kolay şekilde keşfedebilir.",
            },
          ].map(({ icon, title, desc }) => (
          ...
          {[
            {
              ...
              desc: "Takviye edici gıdalar, mikrobiyota, inflamasyon ve sağlık konularında doğal dil ile sorularınızı yöneltin.",
            },
            {
              step: 2,
              title: "AI Analiz Etsin",
              desc: "RAG destekli sistem; bilimsel içerikleri, sağlık verilerini ve bilgi tabanını analiz eder.",
            },
            {
              step: 3,
              title: "Bilimsel Sonuç Alın",
              desc: "Yapay zeka sistemi güvenilir kaynaklardan derlenmiş açıklamalar ve özetler sunar.",
            },
          ].map(({ step, title, desc }) => (
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Nutramol AI; bilimsel yayınlar, sağlık araştırmaları ve modern retrieval sistemleriyle
                desteklenmiş yeni nesil bir AI platformudur.
              </p>
            </div>
      ...
      <section className="relative z-10 px-6 pb-32">
        <div className="mx-auto max-w-5xl rounded-[40px] bg-emerald-600 px-10 py-20 text-center text-white shadow-2xl shadow-emerald-200">
          ...
          <button
            onClick={openChat}
            className="mt-10 rounded-2xl bg-white px-8 py-4 text-lg font-bold text-emerald-700 transition hover:scale-105"
          >
